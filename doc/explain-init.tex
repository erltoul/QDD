...
column 7 of {tt for005ion.<name>}. If more than one state is to be
...
hydrogen. One ought to distribute an equal collection of {\tt +1}
and {\tt -1} entries to avoid unnaturally polarized molecules.
