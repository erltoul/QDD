...
{\tt jescmask} & modulus for detailed print of lost electrons  \textcolor{red}{???}  \\
{\tt jescmaskorb} & modulus for state-wise detailed print of lost electrons \textcolor{red}{???} \\
\hline
\end{tabular}
...
operations  \textcolor{red}{??}\\
{\tt timefrac} &  variable checking CPU time to trigger save operations \textcolor{red}{??}  \\
...
{\tt scatterelectronvxn} &  x-velocity  of impinging electron
wavepacket (relative to {\tt scatterelectronenergy})\\
{\tt scatterelectronvyn} &  y-velocity  of impinging electron
wavepacket (relative to {\tt scatterelectronenergy}) \\
{\tt scatterelectronvzn} &  z-velocity  of impinging electron
wavepacket (relative to {\tt scatterelectronenergy}) \\
