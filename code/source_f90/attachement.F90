...
END IF
WRITE(*,*) ' binerg,reference_energy:',binerg,reference_energy
...
!                                     extract submatrix                                  
                                    ...
                                    IF(ierror == 0) THEN
                                       DO ind=1,kdfull2
                                          ...
                                          tbelement = CONJG(psip(ind))*psipp(ind)  + tbelement
                                       END DO
