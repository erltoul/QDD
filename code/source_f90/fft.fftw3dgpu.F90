...
!COMPLEX(C_DOUBLE_COMPLEX), PRIVATE, ALLOCATABLE :: fftax(:),fftay(:),fftb(:,:),ffta(:,:,:)
...
!CALL run_fft_for3d(p,ffta,ffta,nx2,ny2,nz2)
...
!CALL run_fft_back3d(p,ffta,ffta,nx2,ny2,nz2)
